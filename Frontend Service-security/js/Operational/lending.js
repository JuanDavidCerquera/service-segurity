            ...
            if (response && response.data) {
                ...
                response.data.forEach(function (employed) {
                    ...
                    var option = $("<option>")
                        ...
                        .text(employed.person.firstName); // El texto de la opción será el título del libro
                    // Añade la opción al select
                    selectLibro.append(option);
                });
            }
            ...
            if (response && response.data) {
                ...
                response.data.forEach(function (cliente) {
                    ...
                    var option = $("<option>")
                        ...
                        .text(cliente.person.firstName); // El texto de la opción será el título del libro
                    // Añade la opción al select
                    selectLibro.append(option);
                });
            }
